...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Outer Banks - Episodi 4</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Kur jeta në shtëpi pa mbikëqyrje e John B arrin deri tek ai, ai merr një ndihmë të  <br>
        mirë-kohë - dhe disa spiffing up - nga personi i fundit që ai pret.</p> 
        <br>
