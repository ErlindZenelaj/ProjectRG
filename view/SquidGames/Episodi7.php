...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Squid Games - Episoda 7</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Udhëheqësi i maskuar mirëpret mysafirët VIP për të parë lojën nga afër. <br>
        Në lojën e pestë, disa lojtarë ndihen nën presion</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 58 min</b>
        </div>
        </div>
        <br>
