...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Sex Education - Episodi 8</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Otis ndihet i dhunuar nga libri i Zhanit; Maeve merr rënien për vëllain e saj, Eric <br>
        shërben burgim me një armik të vjetër; Trupi i Lilit e tradhton atë.
        </p> 
        <br>
