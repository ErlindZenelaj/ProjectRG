...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>What If - Episodi 4<h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Një doktor i pikëlluar, Strange, përdor Syrin e Agamotos në një përpjekje të rrezikshme për të ndryshuar të kaluarën.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 40 min</b>
        </div>
        </div>
        <br>
