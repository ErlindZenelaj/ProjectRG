...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/hL6R3HmQfPc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>       
        <h3>Halloween Kills</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Saga e Michael Myers dhe Laurie Strode vazhdon në kapitullin tjetër <br>
        emocionues të serisë së Hallouinit. </p> <br>
        <span><b>Horror</b></span><br>
        <span><b>Koha: 105 min</b>
        </div>
        </div>
        <br>
