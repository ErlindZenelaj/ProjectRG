...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>The Queen's Gambit - Episodi 4 </h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Klasa ruse hap derën për një skenë të re shoqërore. Në qytetin e Meksikos,  <br>
        Beth takon Borgovin e frikshëm, ndërsa nëna e saj bashkohet me një shok peni.</p> 
        <br>
