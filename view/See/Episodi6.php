...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/mwXK06A2sYM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>See - Episodi 6</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Baba dhe familja janë tradhëtuar. Mbretëresha Kejn përdor dinakërinë e saj për t'u përballur me një konflikt të ri.</p> 
        <br>
        ...
        <div class="col-3 "><br>
        <br>
        <a href="../See/Episodi5.html">
        <img src="../img/Serial/See.jpg">
        <h1>Episoda 5</h1></a>
    
            
        <a href="../See/Episodi7.html">
        <img src="../img/Serial/See.jpg">
        <h1>Episoda 7</h1></a>
              
        <a href="../See/Episodi8.html">
        <img src="../img/Serial/See.jpg">
        <h1>Episoda 8</h1></a>
