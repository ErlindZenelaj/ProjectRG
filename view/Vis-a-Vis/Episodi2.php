...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Vis a Vis - Episodi 2<h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Jeta në burg është më e komplikuar tani që Makarena di të jetojë.Ajo u tregon  prindërve  <br>
        të saj pse akuzohet. Babai i saj përpiqet të zgjidhë problemin jashtë për të ndihmuar Macarena.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 49 min</b>
        </div>
        </div>
        <br>
        ...
        <div class="col-3 "><br>
        <br>
        <a href="../Vis-a-Vis/Episodi1.html">
