...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>The Flash - Episoda 8</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Shigjeta vjen në Qytetin Qendror në ndjekje të një krimineli. Barry shpreson të bashkohen, <br>
        por një meta-njeri që mund të kontrollojë emocionet kthehet njëri kundër tjetrit.
        </p> 
        <br>
