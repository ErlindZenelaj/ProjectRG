...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Sex Education - Episodi 7</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Kërcimi i madh nxjerr më të mirën, dhe dramën në trupin studentor të Moordale; Otis <br>
        gjen një datë; Maeve merr fustanin e saj; Eric kthehet me stil.
        </p> 
        <br>
