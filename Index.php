...
<body>
    ...
    <div class="wrapper">
        <nav>
          ...
          <div class="content">
          <div class="logo"><a href="#">RG-Movies</a></div>
            <ul class="links">
              <li><a href="#">Filma</a></li>
              <li><a href="../ProjectRG/Seriale.html">Seriale</a></li>
              <li>
              ...
              <li><a href="../ProjectRG/Anime.html">Anime</a></li>
              <div class="lg">
    ...
    <div class="slider">
		...
		<div class="myslide fade">
			...
			<a href="../ProjectRG/Filmat/SpiderMan1.html"><img src="img1/SpiderMan.jpg" ></a>
		</div>
		...
		<div class="myslide fade">
			...
			<a href="../ProjectRG/Filmat/Venom.html"><img src="img1/Venom.jpg" ></a>
		</div>
		...
		<div class="myslide fade">
            ...
            <a href="../ProjectRG/Seriale/SquidGames.html"><img src="img1/SquidGames.jpg" ></a>
		</div>
		...
		<div class="myslide fade">
			...
			<a href="../ProjectRG/Seriale/LaCasaDePapel.html"><img src="img1/LaCasa.jpg" ></a>
		</div>
    ...
    <div class = "flex">
        <a href="../ProjectRG/Filmat/Shang-Chi.html">
        ...
        <a href="../ProjectRG/Filmat/Free-Guy.html">
        ...
        <a href="../ProjectRG/Filmat/NoTimeToDie.html">
        ...
        <a href="../ProjectRG/Filmat/F9.html">
    ...
    <div class = "flex">
        <a href="../ProjectRG/Filmat/TheSuicideSquad.html">
        ...
        <a href="../ProjectRG/Filmat/BlackWidow.html">
        ...
        <a href="../ProjectRG/Filmat/SpiderManNWH.html">
        ...
        <a href="../ProjectRG/Filmat/HalloweenKills.html">
