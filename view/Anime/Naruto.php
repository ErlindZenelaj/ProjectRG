...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/XlBu-3LM5mc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Naruto the Movie: Ninja Clash in the Land of Snow</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Naruto dhe ekipi i tij janë punësuar për të mbrojtur një aktore të re nga tre luftëtarë  <br>
        mashtrues në Tokën e Borës.</p>
        <br>
        <span><b>Anime</b></span><br>
        <span><b>Koha: 82 min</b>
        </div>
        </div>
        <br>
        ...
        <br>
            ...
            <h1>Naruto Shippuden: The Last</h1></a>
