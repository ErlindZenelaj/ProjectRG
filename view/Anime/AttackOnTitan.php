...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/EIVVnLlhzr0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Attack On Titan</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Pasi qyteti i tij i lindjes shkatërrohet dhe nëna e tij vritet, i riu Eren Jaeger <br>
        zotohet të pastrojë tokën nga Titanët gjigantë humanoidë që e kanë sjellë njerëzimin <br>
        në prag të zhdukjes.</p>
        <br>
        <span><b>Anime</b></span><br>
        <span><b>Koha: 110 min</b>
        </div>
        </div>
        <br>
