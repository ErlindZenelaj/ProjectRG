...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/FHgm89hKpXU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Dragon Ball Super: Broly</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Goku dhe Vexhita ndeshen me Broly, një luftëtar Saiyan ndryshe nga çdo luftëtar <br>
        e të cilin janë përballur më parë.</p>
        <br>
        <span><b>Anime</b></span><br>
        <span><b>Koha: 100 min</b>
        </div>
        </div>
        <br>
        ...
        <br>
            ...
            <h1>Jujutsu Kaisen: The Movie</h1></a>
