...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Squid Games - Episoda 1</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Episodi 1: Duke shpresuar të fitojë para, një Gi-hun plot borxhe dhe i dëshpëruar <br> 
        pranon të marrë pjesë në një lojë enigmatike. Sapo nis raundi i parë, shpalosen tmerre të paparashikuara.</p> 
        <br>
