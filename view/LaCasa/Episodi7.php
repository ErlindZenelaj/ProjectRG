...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>La Casa De Papel - Episodi 7</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Lumturia e Tokios bëhet e hidhur. Ángel mbyllet në një grindje Raquel <br>
        dhe Profesor. Autoritetet ofrojnë një shpërblim shumëmilionësh për bakshish.
        </p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 45 min</b>
        </div>
        </div>
        <br>
