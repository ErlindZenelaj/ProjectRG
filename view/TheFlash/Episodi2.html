...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>The Flash - Episoda 2</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Barry merr një grup burrash të armatosur në një ceremoni çmimesh, por efekte <br>
        anësore nga super fuqia e tij e re kapin atë.
