...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Rrushe - Episodi 5</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Pasojat e aksidentit të Mentorit largohen nga familja Pirulli në kërkim të <br>
        një mrekullie. Ndërkohë, në Dresden, 1995, Demir Jaha i jep Musë Lahu bllokun <br>
        e tij të çmuar dhe niset për në Hamburg, por gjërat nuk shkojnë siç ishte  <br>
        planifikuar për surprizën e tij dhe të të gjithëve.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 55 min</b>
        </div>
        </div>
        <br>
