...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>The Queen's Gambit - Episodi 7</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Një vizitë nga një shoqe e vjetër e detyron Betin të marrë parasysh të kaluarën e saj <br>
        dhe të rimendojë përparësitë e saj, tamam në kohë për ndeshjen më të madhe të jetës së saj.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 67 min</b>
        </div>
        </div>
        <br>
