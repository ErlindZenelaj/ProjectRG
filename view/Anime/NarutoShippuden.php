...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/tA3yE4_t6SY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>The Last: Naruto the Movie</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Motra e vogël e Hinata Hyuga është rrëmbyer, kështu që Naruto duhet të bëjë atë <br>
        që mundet për ta shpëtuar atë.</p>
        <br>
        <span><b>Anime</b></span><br>
        <span><b>Koha: 112 min</b>
        </div>
        </div>
        <br>
