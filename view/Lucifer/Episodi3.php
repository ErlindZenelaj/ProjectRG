...
<body>
    ...
    <div class="wrapper">
        <nav>
          ...
          <div class="content">
          <div class="logo"><a href="../login.php">RG-Movies</a></div>
            <ul class="links">
      ...
      <div class="section group">
        ...
        <h3>Lucifer - Episodi 3</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Një qendërmbrojtës që po vjen thërret Luciferin pasi gjeti një kufomë në pishinën e tij; <br>
        Lucifer i kërkon Chloe të ndihmojë për të hetuar, e cila i çon ata në botën e sporteve me <br>
        para të mëdha.</p> 
        <br>
