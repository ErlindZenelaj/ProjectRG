...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Vis a Vis - Episodi 1</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Znj. Macarena, një ekzekutive e financave, ishte në një lidhje me pronarin.Kjo pronare <br>
        i kripon miliona njerëz dhe e implikon në mënyrë të rreme.E dënuar, përvoja e saj në burg <br>
        është traumatike. Një i burgosur është vrarë, dhe ajo është dërguar në izolim.</p> 
        <br>
