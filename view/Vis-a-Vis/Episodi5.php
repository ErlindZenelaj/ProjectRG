...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Vis a Vis - Episodi 4<h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Një zyrtar burgu akuzohet nga një grua brenda. Babai i Makarenës i kërkon ndihmë një <br>
        shoku të vjetër të punës. Egjiptiani po ndjek Leopoldon dhe Román. Një nga gratë është <br>
        nën presion për të ndihmuar me hetimin policor.<br></p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 44 min</b>
        </div>
        </div>
        <br>
        ...
        <div class="col-3 "><br>
        <br>
        <a href="../Vis-a-Vis/Episodi3.html">
