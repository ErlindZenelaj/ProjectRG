...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="960" height="600" src="https://www.youtube.com/embed/-FZ-pPFAjYY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Batman</h3>
        </div>
        <div class="col-2 ">
