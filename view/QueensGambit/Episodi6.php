...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>The Queen's Gambit - Episodi 6</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Pas trajnimit me Benny në Nju Jork, Beth shkon në Paris për ritakimin e saj <br>
        me Borgov. Por një natë e egër e dërgon atë në një spirale vetëshkatërruese.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 60 min</b>
        </div>
        </div>
        <br>
