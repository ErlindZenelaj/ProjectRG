...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>The Flash - Episoda 4</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Për të vjedhur një diamant të paçmueshëm, Kapiteni Cold fiton një armë të specializuar <br>
        që mund të vrasë Fleshin. Joe nuk e miraton lidhjen me Edin dhe Irisin.
        </p> 
        <br>
