...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Rrushe - Episodi 8</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Mentori kthehet në shtëpi, por nuk duket si vetja e tij. Ndërkohë, më  <br>
        1995 Musë Lahu dhe Samir Hoti përballen me një surprizë të pakëndshme.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 48 min</b>
        </div>
        </div>
        <br>
