...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Loki - Episodi 1</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Loki, Perëndia i Ligësisë, e gjen veten jashtë kohës dhe në një vend të pazakontë  <br>
        dhe i detyruar - kundër prirjes së tij hyjnore - për të bashkëpunuar me të tjerët.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 51 min</b>
        </div>
        </div>
        <br>
