...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>The Flash - Episoda 5</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Ndërsa përpiqet për të marrë Iris për të ndaluar blogimin në lidhje me Flash, <br>
        Barry heton lidhjen e një gjenerali me një meta-njeri shpërthyes.
