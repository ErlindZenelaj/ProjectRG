...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/Poo5lqoWSGw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>One Punch Man - Wanpanman: Road to Hero</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Historia e Saitama, një hero që e bën atë vetëm për argëtim & mund të mposhtë armiqtë <br>
        e tij me një grusht të vetëm.</p>
        <br>
        <span><b>Anime</b></span><br>
        <span><b>Koha: 30 min</b>
        </div>
        </div>
        <br>
