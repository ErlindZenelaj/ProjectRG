...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/nW948Va-l10" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Loki - Episodi 6</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Ora po kalon në finalen e sezonit që gjen Lokin dhe Silvin në një takim me fatin.
        </p> 
        <br>
        ...
        <a href="../Loki/Episodi7.html">
        <img src="../img/Serial/Loki.jpg">
        <h1>Episoda 7 - Coming Soon</h1></a>
              
        <a href="../Loki/Episodi8.html">
          <img src="../img/Serial/Loki.jpg">
        <h1>Episoda 8 - Coming Soon</h1></a>
