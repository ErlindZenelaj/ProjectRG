...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/aSiDu3Ywi8E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>       
        <h3>F9: The Fast Saga</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Dom dhe ekuipazhi duhet të marrin një terrorist ndërkombëtar i cili rezulton të jetë<br>
        vëllai i larguar i Dom dhe Mia.</p>    <br>
        <span><b>Aksion Adventure</b></span><br>
        <span><b>Koha: 143 min</b>
        </div>
        </div>
        <br>
