...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Sex Education - Episodi 6</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Trauma e Erikut e izolon atë; Eseja e Maeve fiton një çmim; Otis përpiqet të takohet <br>
        me Lilin, por çështjet e tij të thella i pengojnë.
        </p> 
        <br>
