...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/X4bF_quwNtw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Lucifer - Episodi 4</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Në një përpjekje për të kapërcyer joshjen e tij me Chloe, Lucifer vendos se ai duhet ta <br>
        joshë atë. Ndërkohë, të dy ata dolën në një çështje për një vajzë të humbur dhe Amenadiel <br>
        përballet me Maze rreth shqetësimeve të tij me Lucifer.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 50 min</b>
        </div>
        </div>
        <br>
        ...
        <div class="col-3 "><br>
        <br>
        <a href="../Lucifer/Episodi3.html">
        <img src="../img/Serial/Lucifer.jpg">
        <h1>Episoda 3</h1></a>
    
            
        <a href="../Lucifer/Episodi5.html">
        <img src="../img/Serial/Lucifer.jpg">
        <h1>Episoda 5</h1></a>
