...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Squid Games - Episoda 9</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Raundi final prezanton një provë tjetër mizore por këtë herë, se si do përfundojë <br>
        do varet nga vetëm një lojtar. Krijuesi i lojës më në fund del nga hija.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 56 min</b>
        </div>
        </div>
        <br>
