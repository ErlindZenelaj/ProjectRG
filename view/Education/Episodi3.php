...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Sex Education - Episodi 3</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Klinika e Otisit arrin ngritje, ashtu si tërheqja e tij ndaj Maeve, i cili në mënyrë <br>
        të papritur i kërkon ndihmë; Eric lëkundet vetëm dhe fushat një come-on.
