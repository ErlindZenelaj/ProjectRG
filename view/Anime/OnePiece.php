...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/S8_YwFLCh4U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>One Piece: Stampede</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Piratët nga e gjithë bota mblidhen në Pirate Expo për t'iu bashkuar gjuetisë për <br>
        thesarin e humbur të Gol D. Roger.</p>
        <br>
        <span><b>Anime</b></span><br>
        <span><b>Koha: 101 min</b>
        </div>
        </div>
        <br>
