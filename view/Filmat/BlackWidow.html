...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/ybji16u608U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>       
        <h3>BlackWidow</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Natasha Romanof përballet me pjesët më të errëta të librit të saj kur <br>lind një komplot i rrezikshëm me lidhje me të kaluarën e saj.</p>    <br>
        <span><b>Aksion Adventure</b></span><br>
        <span><b>Koha: 134 min</b>
        </div>
        </div>
        <br>
