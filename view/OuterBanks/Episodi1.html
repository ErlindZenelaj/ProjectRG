...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Outer Banks - Episodi 1</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Pas një uragani, Xhon B, JJ, Papa dhe Kiara zhyten kokë më kokë në rrezik dhe aventurë  <br>
        kur gjejnë një shkatërrim misterioz të mbytur.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 54 min</b>
        </div>
        </div>
        <br>
