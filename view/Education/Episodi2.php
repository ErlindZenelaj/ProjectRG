...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/Hd2ldTR-WpI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Sex Education - Episodi 2</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>I ndjekur nga Maeve, dhe duke gjetur se dhënien e këshillave për seksin është më e <br>
        vështirë se sa ai mendonte, Otis përpiqet të ofrojë këshilla falas në festën e një shoku klase.
        </p> 
        <br>
