...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>The Queen's Gambit - Episodi 5</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Në shtëpi në Kentaki, një Beth e tronditur rilidhet me një ish kundërshtare <br>
        që ofron për të ndihmuar në mprehjen e lojës së saj përpara kampionatit amerikan.
        </p> 
        <br>
