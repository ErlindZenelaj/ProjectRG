...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/oZn3qSgmLqI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>The Queen's Gambit - Episodi 1</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>I dërguar në një jetimore në moshën 9 -vjeçare, Beth zhvillon një aftësi të pashuar për <br>
        shahun dhe një varësi gjithnjë e më të madhe nga qetësuesit e gjelbër që u jepen fëmijëve.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 59 min</b>
        </div>
        </div>
        <br>
