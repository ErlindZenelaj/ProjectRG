...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/-FZ-pPFAjYY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Batman</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Një film i bazuar në vitin e dytë të Batmanit për të luftuar
         krimin dhe e ndjek atë ndërsa <br>eksploron korrupsionin e Gotham City dhe përballet me Riddler,
        një vrasës serial i fiksuar pas enigmës.</p>
        <br>
        <span><b>Aksion Adventure</b></span><br>
        <span><b>Koha: 120 min</b>
        </div>
        </div>
        <br>
