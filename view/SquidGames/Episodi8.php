...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Squid Games - Episoda 8</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Përpara raundit të fundit, mosbesimi dhe frika janë përhapur mes finalistëve.  <br>
        Jun-ho arratiset, i vendosur për të ekspozuar sekretet e lojës</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 32 min</b>
        </div>
        </div>
        <br>
