...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/X2m-08cOAbc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>       
        <h3>Free-Guy</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Një bankier zbulon se ai është në fakt një NPC brenda një videoloje brutale dhe të hapur botërore</p>    <br>
        <span><b>Komedi</b></span><br>
        <span><b>Koha: 155 min</b>
        </div>
        </div>
        <br>
