...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/sxufB6DxXk0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Dragon Ball Z: Battle Of Gods </h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Z-Fighters duhet të luftojnë me Zotin Beerus, Perëndinë e Shkatërrimit, por vetëm një <br>
        Zot mund të luftojë një Zot dhe asnjëri prej tyre nuk është Zot. Megjithatë, me krijimin <br>
         e Zotit Super Saiyan, a do të jenë në gjendje Z-Fighters të mposhtin Lord Beerus?</p>
        <br>
        <span><b>Anime</b></span><br>
        <span><b>Koha: 85 min</b>
        </div>
        </div>
        <br>
