...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>La Casa De Papel - Episodi 6</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Ashtu si inspektori Sierra orkestron një plan për të futur një skuadër në  <br>
        Bankën e Spanjës, profesori dhe Rakela humbasin komunikimin me Palermon.</p> 
        <br>
