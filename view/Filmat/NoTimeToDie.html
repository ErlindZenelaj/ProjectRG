...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/BIhNsAtPbPI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>       
        <h3>No Time To Die</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>James Bond ka lënë shërbimin aktiv. Paqja e tij është jetëshkurtër <br>
        kur Felix Leiter, një mik i vjetër nga CIA, del duke kërkuar ndihmë, <br>
        duke e çuar Bondin në gjurmët e një horri misterioz të armatosur me teknologji të re të rrezikshme. </p> <br>
        <span><b>Action Adventure</b></span><br>
        <span><b>Koha: 163 min</b>
        </div>
        </div>
        <br>
