...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/JuDLepNa7hw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>       
        <h3>The Suicide Squad</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Super villains Harley Quinn, Bloodsport, Peacemaker dhe një koleksion  <br>
        të kons nutty në Belle Reve burg bashkohen super-sekret,super-hije Task Force X <br>
        si ata janë hedhur jashtë në ishullin e largët, armik-infused të Corto Maltese. </p> <br>
        <span><b>Action Adventure Comedy</b></span><br>
        <span><b>Koha: 132 min</b>
        </div>
        </div>
        <br>
