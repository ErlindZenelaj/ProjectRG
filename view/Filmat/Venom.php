...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/-FmWuCgJmxo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>       
        <h3>Venom</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p> Eddie Brock lufton për t'u përshtatur me jetën e tij të re si
        mikpritësi i simbiote aliene Venom, <br> e cila i jep atij aftësi super-njerëzore
        në mënyrë që të jetë një vigjilent vdekjeprurës.<br> Brock përpiqet të rindezë karrierën e tij duke intervistuar vrasësin serial Cletus Kasady,
        i cili bëhet <br>organizatori i masakrës simbiote dhe i shpëton burgut pas një ekzekutimi të dështuar</p>
        <br>
        <span><b>Aksion Adventure</b></span><br>
        <span><b>Koha: 97 min</b>
        </div>
        </div>
        <br>
