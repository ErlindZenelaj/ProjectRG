...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>What If - Episodi 2<h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Piratët hapsinor të ashpër të njohur si Ravagers rrëmbyen T'Challa në vend të Peter Quill.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 38 min</b>
        </div>
        </div>
        <br>
