...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Outer Banks - Episodi 6</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Një legjendë e frikshme e ishullit, një miqësi e prishur dhe gjendja e re jetësore e  <br>
        Xhon B e mbajnë ekuipazhin në këmbë ndërsa kërkojnë lart e poshtë për thesarin.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 53 min</b>
        </div>
        </div>
        <br>
        ...
        <a href="../OuterBanks/Episodi8.html">
        <img src="../img/Serial/OuterBanks.jpg">
        <h1>Episoda 8</h1></a>
