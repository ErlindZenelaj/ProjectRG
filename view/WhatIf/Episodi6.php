...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/x9D0uUKJ5KI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>What If - Episodi 6<h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Killmonger shpëton Tony Stark kur Humvee e tij është sulmuar në Afganistan dhe manipulon <br>
        ndikimin e tij për dizajnet e tij të pushtimit Wakanda.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 42 min</b>
        </div>
        </div>
        <br>
        ...
        <a href="../WhatIf/Episodi7.html">
        <img src="../img/Serial/WhatIf.jpg">
        <h1>Episoda 7</h1></a>
              
        <a href="../WhatIf/Episodi8.html">
        <img src="../img/Serial/WhatIf.jpg">
        <h1>Episoda 8</h1></a>
