...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/Yj0l7iGKh8g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>The Flash - Episoda 7</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Duke përdorur fuqinë e tij meta-njerëzore për të siphon elektricitetin, Blackout grabit  <br>
        Barry nga shpejtësia e tij, pastaj vendos sytë e tij në laboratorët E.T.A.R. dhe Dr. Wells.
        </p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 43 min</b>
        </div>
        </div>
        <br>
