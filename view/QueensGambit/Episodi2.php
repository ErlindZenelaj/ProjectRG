...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>The Queen's Gambit - Episodi 2</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Papritur u zhyt në një jetë të re pështjelluese në periferi, Beth adoleshente studion <br>
        shokët e klasës së shkollës së mesme dhe hap një plan për të hyrë në një turne shahu.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 65 min</b>
        </div>
        </div>
        <br>
