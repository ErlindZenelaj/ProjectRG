...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/JfVOs4VSpmA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>       
        <h3>Spider Man: No Way Home</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Me identitetin e Njeriut-Merimangë tani të zbuluar, Pjetri i kërkon ndihmë Doktorit Strange. <br>
        Kur një magji shkon keq, armiqtë e rrezikshëm nga botët e tjera fillojnë të shfaqen, <br>
        duke e detyruar Pjetrin të zbulojë se çfarë do të thotë me të vërtetë të jesh Njeriu Merimangë. </p> <br>
        <span><b>Aksion Adventure</b></span><br>
        <span><b>Koha: 148 min</b>
        </div>
        </div>
        <br>
