...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Outer Banks - Episodi 2</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>I bindur se çelësi që gjendet në barkë lidhet me babanë e tij të humbur, Xhon B i çon  <br>
        miqtë e tij në një kërkim gjithnjë e më të furishëm për përgjigje.</p> 
        <br>
        ...
        <div class="col-3 "><br>
        <br>
        <a href="../OuterBanks/Episodi1.html">
        <img src="../img/Serial/OuterBanks.jpg">
        <h1>Episoda 1</h1></a>
    
            
        <a href="../OuterBanks/Episodi3.html">
        <img src="../img/Serial/OuterBanks.jpg">
        <h1>Episoda 3</h1></a>
