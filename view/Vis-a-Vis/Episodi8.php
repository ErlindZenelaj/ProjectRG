...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480"src="https://www.youtube.com/embed/ceNKwOvSVm8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Vis a Vis - Episodi 8<h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>I dashuri i Zulemas hyn fshehurazi në shtëpinë e familjes së Macarenas dhe vjedh fotografitë  <br>
        që tregojnë vendndodhjen sekrete të milionave të vjedhura. Fabio e informon Macarena për një <br>
        tradhëti. Zulema merr një mesazh sekret.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 46 min</b>
        </div>
        </div>
        <br>
        ...
        <a href="../Vis-a-Vis/Episodi6.html">
        <img src="../img/Serial/Vis-a-Vis.jpg">
        <h1>Episoda 6</h1></a>
              
        <a href="../Vis-a-Vis/Episodi7.html">
        <img src="../img/Serial/Vis-a-Vis.jpg">
        <h1>Episoda 7</h1></a>
