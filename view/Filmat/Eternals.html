...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/x_me3xsvDgk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>       
        <h3>Eternals</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Saga e të Përjetshmeve, një racë qeniesh të pavdekshme që jetuan në Tokë dhe modeluan historinë dhe qytetërimet e saj</p>        <br>
        <span><b>Aksion Adventure</b></span><br>
        <span><b>Koha: 156 min</b>
        </div>
        </div>
        <br>
