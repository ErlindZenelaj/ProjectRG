...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Vis a Vis - Episodi 7<h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Macarena ka ndryshuar mendje për shtatzëninë e saj dhe është e lumtur që pret një djalë <br>
        të vogël. Drejtori jep një lajm të mirë. Zulema po shqetësohet gjithnjë e më shumë për <br>
        heshtjen e të dashurit të saj.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 47 min</b>
        </div>
        </div>
        <br>
        ...
        <a href="../Vis-a-Vis/Episodi8.html">
        <img src="../img/Serial/Vis-a-Vis.jpg">
        <h1>Episoda 8</h1></a>
