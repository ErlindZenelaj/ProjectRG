...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>What If - Episodi 8<h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Natasha Romanof dhe Clint Barton kërkojnë të shkatërrojnë robotin vrasës Ultron  <br>
        pas një ngjarje kataklizmike..</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 39 min</b>
        </div>
        </div>
        <br>
