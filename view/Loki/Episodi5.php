...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>Loki - Episodi 5</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Loki përpiqet të shpëtojë nga The Void, një purgator i shkretë ku ai takon <br>
        versionet variante të vetes.
        </p> 
        <br>
