...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/c2OvEy5GBrc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Rrushe - Episodi 6</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Musë Lahu kthehet për të takuar babanë e Demirit, Zekë Jaha, organizatorin prapa <br>
        Qendresës. Ai ka lajme për djalin e tij dhe i sjell Zekë bllokun e shënimeve.   <br>
        Lëvizja Qendresa po fillon. Në anën tjetër, Mentori më në fund është zgjuar, por  <br>
        incidentet e kaluara gjithashtu zgjohen kur babai i Mentorit, Faruk, e viziton atë.</p> 
        <br>
        <span><b>Serial</b></span><br>
        <span><b>Koha: 52 min</b>
        </div>
        </div>
        <br>
        ...
        <a href="../Rrushe/Episodi7.html">
        <img src="../img/Serial/Rrushe.jpg">
        <h1>Episoda 7</h1></a>
              
        <a href="../Rrushe/Episodi8.html">
        <img src="../img/Serial/Rrushe.jpg">
        <h1>Episoda 8</h1></a>
