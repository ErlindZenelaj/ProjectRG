...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/pfY3j-3uQhk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Outer Banks - Episodi 3</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Ndërsa banda nxjerr një skemë të paligjshme për të shkuar në fund të misterit të <br>
        detit të thellë, Xhon B përballet me Sarën ndërsa Papa kërcen në shansin për hakmarrje.</p> 
        <br>
        ...
        <div class="col-3 "><br>
        <br>
        <a href="../OuterBanks/Episodi2.html">
        ...
        <a href="../OuterBanks/Episodi5.html">
        <img src="../img/Serial/OuterBanks.jpg">
        <h1>Episoda 5</h1></a>
