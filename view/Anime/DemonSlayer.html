...
<body>
    ...
    <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/bFwdl2PDAFM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>Demon Slayer: Mugen Train </h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Pasi familja e tij u vra brutalisht dhe motra e tij u shndërrua në një demon, filloi <br>
        udhëtimi i Tanjiro Kamado si një vrasës demonësh. Tanjiro dhe shokët e tij nisin një  <br>
        mision të ri në bordin e trenit Mugen, në rrugën e dëshpërimit.</p>
        <br>
        <span><b>Anime</b></span><br>
        <span><b>Koha: 117 min</b>
        </div>
        </div>
        <br>
