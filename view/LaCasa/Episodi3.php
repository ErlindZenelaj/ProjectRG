...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        <div class="col-1">
        <iframe width="750" height="480" src="https://www.youtube.com/embed/TFJwUwnShnA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
        <h3>La Casa De Papel - Episodi 3</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Përpjekjet e Tokios dhe të Najrobit shkojnë shumë në një kohë të papritur.Profesori  <br>
        kujton Berlinin duke dhënë hollësi se si do ta vidhnin arin nga kasaforta e mbushur me ujë.</p> 
        <br>
