...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="section group">
        ...
        <h3>La Casa De Papel - Episodi 4</h3>
        </div>
        <div class="col-2 ">
        <div class="col-2-1"> <br>
        <h4>Përmbledhje</h4> <br>
        <p>Thyerjet e protokollit të Tamayo-s befasojnë Profesorin. Bogotá qetëson <br>
        ankthet e Denverit. Me kalimin e kohës, Palermo inicion planin "Flipper".</p> 
        <br>
